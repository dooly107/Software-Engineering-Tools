...
if (( $Num_Of_Param == 1 ))
then
    echo "The number of Parameter is less than one. You should enter two parameters."
    exit 1
elif (( $Num_Of_Param == 0 ))
then
...
then
    echo "The number of Parameters are more than three. You should enter two parameters."
    exit 1
